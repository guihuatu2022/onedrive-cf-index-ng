...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'guihuatu@hotmail.com',
  ...
  protectedRoutes: ['/cfweb/mylife','/cfweb'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:guihuatu@inlnl.com',
